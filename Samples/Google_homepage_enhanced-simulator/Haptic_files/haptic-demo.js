...
contentLoaded(window, function(){
    ...
    // Enable haptic cursor simulation via mouse coordinates capture
    // by defining the properties of the device to simulate:
	var dev = new jhaptic.VirtualDevice(3.3, new jhaptic.Vector(0.2,0.15,0.1));
